...
"}")
        ...
        self.agregarPedido =  QtWidgets.QPushButton(self.frame)
        self.agregarPedido.setObjectName(u"agregarPedido")
        self.agregarPedido.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.verticalLayout.addWidget(self.agregarPedido)
    ...
    def retranslateUi(self, pedidos):
        ...
        self.agregarPedido.setText(_translate("pedidos", u"a\u00f1adir pedido", None))
        self.submit.setText(_translate("pedidos", "Enviar Pedido"))
    
    def crear_nuevo_combo_box(self):
        self.item.setStyleSheet("QLineEdit,QComboBox{\n"
"border: 0px solid transparent;\n"
"border-bottom: 2px solid #FE59A8;\n"
"border-left: 2px solid #FE59A8;\n"
